                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ url('/docs') }}">Documentos</a></li>
                            <li><a href="{{ url('/regs') }}">Registros</a></li>
                            <li><a href="{{ url('/cal') }}">Calibração</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ url('/aud') }}">Auditorias</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ url('/analise') }}">Analise Critica</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Aquisição <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ url('/fornec') }}">Fornecedores</a></li>
                        </ul>
                    </li>
                    @if (! Auth::guest())
